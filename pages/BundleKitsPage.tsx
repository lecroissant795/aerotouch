        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {BUNDLE_KITS.map((kit) => (
            <div
              ...
              onKeyDown={(e) => e.key === 'Enter' && onKitSelect?.(kit)}
              className="group relative flex flex-col h-full bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-slate-200/50 hover:-translate-y-1 hover:border-slate-200 cursor-pointer"
            >
