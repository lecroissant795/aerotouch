import { handleCartAbandonmentRequest } from './cart-abandonment.handler.shared.js'
...
export default async function handler(req, res) {
  ...
  const result = await handleCartAbandonmentRequest(payload, getEnv, clientContext)
