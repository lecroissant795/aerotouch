...
const HEIGHT_BOOSTER_REAL_RESULT_PHOTOS = [
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/height%20boosters/Screenshot%202026-05-12%20at%2011.54.32%20pm.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/height%20boosters/Screenshot%202026-05-12%20at%2011.52.40%20pm.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/height%20boosters/Screenshot%202026-05-12%20at%2011.52.32%20pm.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/height%20boosters/Screenshot%202026-05-12%20at%2011.48.16%20pm.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/height%20boosters/Screenshot%202026-05-12%20at%2011.47.52%20pm.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/height%20boosters/Screenshot%202026-05-12%20at%2011.47.37%20pm.png',
] as const;

const GRIP_SOCKS_REAL_RESULT_PHOTOS = [
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/grip%20socks/Screenshot%202026-05-13%20at%203.53.41%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/grip%20socks/Screenshot%202026-05-13%20at%203.53.49%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/grip%20socks/Screenshot%202026-05-13%20at%203.54.01%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/grip%20socks/Screenshot%202026-05-13%20at%203.54.12%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/grip%20socks/Screenshot%202026-05-13%20at%203.54.30%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/grip%20socks/Screenshot%202026-05-13%20at%203.56.49%20am.png',
] as const;

const HEEL_CUSHIONS_REAL_RESULT_PHOTOS = [
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/heel%20cushions/Screenshot%202026-05-13%20at%204.39.44%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/heel%20cushions/Screenshot%202026-05-13%20at%204.40.09%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/heel%20cushions/Screenshot%202026-05-13%20at%204.40.41%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/heel%20cushions/Screenshot%202026-05-13%20at%204.42.53%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/heel%20cushions/Screenshot%202026-05-13%20at%204.43.02%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/heel%20cushions/Screenshot%202026-05-13%20at%204.43.34%20am.png',
] as const;

const TOE_CUSHION_PADS_REAL_RESULT_PHOTOS = [
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/cushion%20pads/b90fbf74-0088-40da-a628-5d2c6b1c3ec7_735x773.jpeg.compressed.avif',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/cushion%20pads/Screenshot%202026-05-13%20at%204.09.57%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/cushion%20pads/Screenshot%202026-05-13%20at%204.10.09%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/cushion%20pads/Screenshot%202026-05-13%20at%204.10.52%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/cushion%20pads/Screenshot%202026-05-13%20at%204.11.03%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/cushion%20pads/Screenshot%202026-05-13%20at%204.11.19%20am.png',
] as const;

const TOE_SPACERS_REAL_RESULT_PHOTOS = [
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/toe%20spacers/Screenshot%202026-05-13%20at%204.20.35%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/toe%20spacers/Screenshot%202026-05-13%20at%204.21.37%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/toe%20spacers/Screenshot%202026-05-13%20at%204.28.08%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/toe%20spacers/Screenshot%202026-05-13%20at%204.29.39%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/toe%20spacers/Screenshot%202026-05-13%20at%204.31.20%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/toe%20spacers/Screenshot%202026-05-13%20at%204.31.51%20am.png',
  'https://mhecgxhcmohbmeimrfud.supabase.co/storage/v1/object/public/media/reviews/toe%20spacers/Screenshot%202026-05-13%20at%204.32.12%20am.png',
] as const;
...
const REAL_RESULT_REVIEWS: Record<SecondaryReviewProductKey, RealResultReview[]> = {
  ...
  gripSocks: [
    withImage(rr(1, 'Keira Walsh', 'Pilates Coach', 'No slipping on the reformer', "The grip is exactly where I need it. I can cue clients and demonstrate without adjusting my feet every few minutes.", '2 days ago'), GRIP_SOCKS_REAL_RESULT_PHOTOS[0]),
    withImage(rr(2, 'Nathan Quinn', 'Physical Therapist', 'Stable through balance work', "I use them for mobility drills at home. The sole grip makes single-leg work feel controlled without needing shoes.", '3 days ago'), GRIP_SOCKS_REAL_RESULT_PHOTOS[1]),
    withImage(rr(3, 'Priyanka Desai', 'Yoga Student', 'Better grounding in class', "My old socks twisted during flows. These stay put and help me feel more planted in lunges and standing poses.", '5 days ago'), GRIP_SOCKS_REAL_RESULT_PHOTOS[2]),
    withImage(rr(4, 'Logan Reed', 'Home Gym User', 'Great for mat workouts', "I wanted something between barefoot and trainers. These are comfortable for stretching, core work, and light circuits.", '1 week ago'), GRIP_SOCKS_REAL_RESULT_PHOTOS[3]),
    withImage(rr(5, 'Amelia Scott', 'Barre Instructor', 'Grip without bulk', "They are thin enough to feel the floor but grippy enough that my feet are not sliding during pulses.", '1 week ago'), GRIP_SOCKS_REAL_RESULT_PHOTOS[4]),
    withImage(rr(6, 'Benji Morales', 'Dance Teacher', 'Secure for studio warmups', "I use them before switching into dance shoes. The fit is snug, and the traction gives me confidence on slick studio floors.", '2 weeks ago'), GRIP_SOCKS_REAL_RESULT_PHOTOS[5]),
  ...
  heelCushions: [
    withImage(rr(1, 'Riley Shaw', 'Retail Lead', 'Saved my stiff work shoes', "My heels used to rub raw by closing time. These pads softened the back of the shoe and made the fit feel much more secure.", '2 days ago'), HEEL_CUSHIONS_REAL_RESULT_PHOTOS[0]),
    withImage(rr(2, 'Monica Alvarez', 'Dental Assistant', 'Less heel ache on tile floors', "Clinic floors are unforgiving. The cushions take the sharp edge off every step, especially when I am standing chairside for hours.", '4 days ago'), HEEL_CUSHIONS_REAL_RESULT_PHOTOS[1]),
    withImage(rr(3, 'Peter Lawson', 'Security Officer', 'No more heel slipping', "One pair of boots was just a little loose. These filled the gap neatly and stopped my heel from lifting with every step.", '6 days ago'), HEEL_CUSHIONS_REAL_RESULT_PHOTOS[2]),
    withImage(rr(4, 'Sienna Hart', 'Flight Attendant', 'Great for breaking in flats', "New flats usually destroy the back of my heels. I added these before a trip and got through the day without blisters.", '1 week ago'), HEEL_CUSHIONS_REAL_RESULT_PHOTOS[3]),
    withImage(rr(5, 'Graham Lee', 'Delivery Driver', 'Simple fix for hard shoes', "I am in and out of the van all day. They stay stuck, do not bunch up, and make my work shoes feel less harsh.", '1 week ago'), HEEL_CUSHIONS_REAL_RESULT_PHOTOS[4]),
    withImage(rr(6, 'Hazel Price', 'Bartender', 'Helped during long service', "Standing behind the bar used to leave my heels tender. These cushions are small, but the comfort difference is obvious.", '2 weeks ago'), HEEL_CUSHIONS_REAL_RESULT_PHOTOS[5]),
  ...
  heightBoosters: [
    withImage(rr(1, 'Adrian Cole', 'Sales Representative', 'Subtle confidence in work shoes', "I did not want obvious lifts. These sit inside my Oxfords cleanly and give me a bit more presence without changing how I walk.", '2 days ago'), HEIGHT_BOOSTER_REAL_RESULT_PHOTOS[0]),
    withImage(rr(2, 'Mira Weston', 'Event Planner', 'Great for photos and long events', "I use them in boots for client events. They add height without looking like platforms, and I can still move around all day.", '4 days ago'), HEIGHT_BOOSTER_REAL_RESULT_PHOTOS[1]),
    withImage(rr(3, 'Theo Banks', 'Graduate Student', 'No awkward stacked feeling', "Cheap inserts felt like standing on blocks. These feel more cushioned and gradual, so I actually kept wearing them.", '5 days ago'), HEIGHT_BOOSTER_REAL_RESULT_PHOTOS[2]),
    withImage(rr(4, 'Celeste Yang', 'Photographer', 'Helpful behind the camera', "A little extra height helps when I am shooting groups. They are discreet enough that nobody notices, which is the point.", '1 week ago'), HEIGHT_BOOSTER_REAL_RESULT_PHOTOS[3]),
    withImage(rr(5, 'Jonah Price', 'Realtor', 'Works in dress boots', "Showings mean a lot of standing and first impressions. These make me feel sharper without making my shoes uncomfortable.", '1 week ago'), HEIGHT_BOOSTER_REAL_RESULT_PHOTOS[4]),
    withImage(rr(6, 'Leila Morgan', 'Office Manager', 'Comfortable for full office days', "I expected to swap them out by lunch. Instead, they stayed comfortable and gave me the subtle lift I wanted.", '2 weeks ago'), HEIGHT_BOOSTER_REAL_RESULT_PHOTOS[5]),
  ...
  toeCushionPads: [
    withImage(rr(1, 'Molly Harris', 'Boutique Associate', 'Stopped front-shoe rubbing', "My toes used to feel raw in new flats. These add just enough cushion where the shoe rubs without making the fit tight.", '2 days ago'), TOE_CUSHION_PADS_REAL_RESULT_PHOTOS[0]),
    withImage(rr(2, 'Julian Watts', 'Daily Commuter', 'Comfort in narrow sneakers', "I walk to the train every morning. The pads take away that hot spot near the front of my shoe.", '4 days ago'), TOE_CUSHION_PADS_REAL_RESULT_PHOTOS[1]),
    withImage(rr(3, 'Hana Mori', 'Server', 'No constant adjusting', "I needed cushioning that stayed put during a dinner rush. These are low profile and I barely notice them once they are in.", '5 days ago'), TOE_CUSHION_PADS_REAL_RESULT_PHOTOS[2]),
    withImage(rr(4, 'Felix Grant', 'Sales Associate', 'Helpful for break-in days', "New shoes usually punish my toes. I added these before a full shift and avoided the usual blisters.", '1 week ago'), TOE_CUSHION_PADS_REAL_RESULT_PHOTOS[3]),
    withImage(rr(5, 'Renee Foster', 'Flight Attendant', 'Soft barrier for long days', "They help where my work shoes press at the front. I like that they do not feel bulky in dress shoes.", '1 week ago'), TOE_CUSHION_PADS_REAL_RESULT_PHOTOS[4]),
    withImage(rr(6, 'Tina Nguyen', 'Nail Technician', 'Gentle cushioning in flats', "I sit and stand all day in flats. These make the toe area feel softer without sliding around.", '2 weeks ago'), TOE_CUSHION_PADS_REAL_RESULT_PHOTOS[5]),
  ...
  toeSpacers: [
    withImage(rr(1, 'Brianna Cole', 'Yoga Teacher', 'Feet feel more open', "After teaching in bare feet all day, wearing these at night helps my toes relax instead of staying cramped together.", '2 days ago'), TOE_SPACERS_REAL_RESULT_PHOTOS[0]),
    withImage(rr(2, 'Devon Harper', 'Trail Runner', 'Great recovery after runs', "My forefoot gets tight after hills. Twenty minutes with the spacers makes my toes feel less compressed.", '4 days ago'), TOE_SPACERS_REAL_RESULT_PHOTOS[1]),
    withImage(rr(3, 'Elise Warner', 'Ballet Instructor', 'Gentle reset after class', "My feet spend hours inside tight shoes. These are an easy reset when I get home, especially around the big toe.", '6 days ago'), TOE_SPACERS_REAL_RESULT_PHOTOS[2]),
    withImage(rr(4, 'Martin Jensen', 'Office Manager', 'Helpful after dress shoes', "Dress shoes leave my toes squeezed by the end of the day. These help everything spread out again while I watch TV.", '1 week ago'), TOE_SPACERS_REAL_RESULT_PHOTOS[3]),
    withImage(rr(5, 'Paige Lin', 'Nurse', 'Comfortable nightly routine', "I started with ten minutes and worked up slowly. Now they are part of my post-shift recovery routine.", '1 week ago'), TOE_SPACERS_REAL_RESULT_PHOTOS[4]),
    withImage(rr(6, 'Carter Stone', 'Rock Climber', 'Good forefoot relief', "Climbing shoes are brutal. The spacers help my toes stop feeling jammed together after gym sessions.", '2 weeks ago'), TOE_SPACERS_REAL_RESULT_PHOTOS[5]),
    withImage(rr(7, 'Fiona Patel', 'Pilates Instructor', 'Better grounding work', "They make my feet feel more aware during footwork. I use them before bed and sometimes before class.", '2 weeks ago'), TOE_SPACERS_REAL_RESULT_PHOTOS[6]),
